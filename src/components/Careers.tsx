...
function Careers() {
  ...
  return (
    <div className={theme? ' bg-sun-light text-sun-dark' : 'text-sun-dark dark-one bg-sun-darkmode'}>
      ...
      <Header/>
        <div className="mt-40 h-max w-5/6  mx-auto text-sun-dark">
          ...
          <p className='text-lg w-4/5 mx-auto'>TheKabadiwala is looking for world-class talent ready to tackle challenging projects that will ultimately make our planet green. We are an equal opportunity employer offering competitive salaries, comprehensive health benefits and equity packages.Content Writer</p>
